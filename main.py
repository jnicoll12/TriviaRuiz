...
print(RESET+
    "Perfecto, ahora", nombre,
    " responderas las siguientes preguntas escribiendo la letra de la alternativa y presionando 'Entrer' para enviar tu respuesta, cada pregunta tiene un valor de 5 puntos, por cada pregunta equivocada se te restará 1:\n"
)

while iniciar_trivia == True:
  #Indicamos con cuantos puntos inicia el juego
  print(RED+"Comenzaras con ", puntaje * edad, " puntos \nIniciamos en... \n")
  ...
  if respuesta_2 == "a":
      print("Totalmente incorrecto!", nombre,
            "En 1932, inicia la Revolución de Trujillo. \n")
      puntaje / 2
  elif respuesta_2 == "b":
      print(
          "Incorrecto!", nombre,
          "En 1541, es asesinado el conquistador del Tahuantisuyo, Francisco Pizarro, a manos de los almagristas. \n"
      )
      puntaje + 5
  elif respuesta_2 == "c":
      ...
      print("********************BONUS********************")
      print("********************BONUS********************")
      print("Respuesta secreta!", nombre,
            " recibirás un bonus de 1000 puntos. \n")
  else:
